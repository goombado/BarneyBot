# CHESS SUDOKU GENERATOR
# RULES:    NORMAL SUDOKU
#           CELLS SEPERATED BY KNIGHT'S OR KING'S MOVE CANNOT BE SAME NUMBER
#           ORTHOGONALLY ADJACENT CELLS CANNOT BE CONSECUTIVE DIGITS
